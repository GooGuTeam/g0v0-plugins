...
This repository contains plugins for g0v0-server developed by GooGuTeam.
...
All plugins in this repository are licensed under the AGPL-3.0 License. See [LICENSE](LICENSE) for more details.
